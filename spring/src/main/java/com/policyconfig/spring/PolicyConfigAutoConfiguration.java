...
import com.policyconfig.api.PolicyKeyRegistry;
...
public class PolicyConfigAutoConfiguration {
	...
	public PolicyResolver policyResolver(
		...
		ObjectProvider<com.policyconfig.core.source.ConfigSource> configSources,
	...
	private static void registerBinding(PolicyConfigs.Builder builder, PolicyConverterBinding<?> binding) {
		builder.converter((Class) binding.type(), (com.policyconfig.api.PolicyValueConverter) binding.converter());
	}
}
